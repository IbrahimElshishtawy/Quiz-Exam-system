...
class InstructorAiAssistantTab extends GetView<InstructorDashboardController> {
  const InstructorAiAssistantTab({super.key});
      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            Expanded(
              child: Obx(() {
                final List<InstructorChatMessage> messages = controller.chatMessages;
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final InstructorChatMessage msg = messages[index];
                    ...
                    child: Container(
                      ...
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                          hintText: 'اسأل عن الأسئلة، تقارير أداء الطلاب...',
  ...
  Widget _buildChatBubble(InstructorChatMessage msg) {
    const primaryColor = Color(0xFF005BBF);
